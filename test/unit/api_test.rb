...
class APITest < Test::Unit::TestCase
  ...
  #   thing = @thingiverse.things.create(:name => 'From thingiverse-ruby: Create Test Thing With File', :license => 'cc-sa', :category => 'other', :description => 'foo bar', :is_wip => true)
  ...
  # def test_ply_file_upload
  #   thing = @thingiverse.things.create(:name => 'Create Test Thing With PLY File', :license => 'cc-sa', :category => 'other', :description => 'foo bar', :is_wip => true)
  #   file = thing.upload(File.open(File.dirname(__FILE__) + '/../fixtures/test.ply'))
  # 
  #   assert file.name == 'test.ply'
  # end
